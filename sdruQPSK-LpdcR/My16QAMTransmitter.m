...
prm16QAMTransmitter = sdru16QAMtransmitter_init(platform)
prm16QAMTransmitter.Platform = platform;
prm16QAMTransmitter.Address = address;
...
if compileIt
    codegen('runSDRuQPSKTransmitter', '-args', {coder.Constant(prm16QAMTransmitter)}); %#ok<UNRCH>
end
if useCodegen
   clear runSDRuQPSKTransmitter_mex %#ok<UNRCH>
   runSDRuQPSKTransmitter_mex(prm16QAMTransmitter);
else
   runSDRu16QAMTransmitter(prm16QAMTransmitter);
end
%%
