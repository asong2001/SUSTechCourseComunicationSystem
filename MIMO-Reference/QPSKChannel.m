...
%                 'SamplesPerSymbol', obj.UpsamplingFactor);
            ...
            obj.pMIMOChannel = comm.MIMOChannel(...
                'SampleRate',obj.SampleRate,...
                'PathDelays',obj.tau,...
                'AveragePathGains',obj.pdb,...
                'MaximumDopplerShift',obj.maxDopp,...
...
%             
%             % Delayed signal
%             delayedSignal = obj.pVariableTimeDelay(TxSignal, delay);


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            chanOut = sum(obj.H22.* TxSignal, 2);
            Out = squeeze(chanOut);
            corruptSignal = obj.pAWGNChannel(Out);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
