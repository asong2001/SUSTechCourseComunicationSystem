    ...
    methods (Access = protected)
        function setupImpl(obj, ~, ~)
            ...
            obj.pPrbDet = comm.PreambleDetector(obj.pModulatedHeader, ...
                ...
                'Threshold', 8);
%             
%             obj.pFrameSync = comm.FrameSynchronizer( ...
...
%                 'PreambleLength', length(obj.pModulatedHeader));
        ...
        function [combinedData,BER] = stepImpl(obj, bufferSignal)
            chEst = obj.H22;
            combinedData = obj.phOSTBCComb(bufferSignal,chEst);
            obj.pBER = obj.pDataDecod(combinedData);
%             RCRxSignal = obj.pRxFilter(combinedData);
%             AGCSignal = obj.DesiredAmplitude*obj.pAGC(combinedData);     % AGC control          
