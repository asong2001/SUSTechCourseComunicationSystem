...
classdef QPSKScopes < matlab.System
    ...
    methods (Access=protected)
        ...
        function stepImpl(obj, RCRxSignal, coarseCompBuffer, timingRecBuffer)
            ...
            obj.pRxScope(RCRxSignal);                    % Plots the spectrum scope of the filtered signal     
            obj.pFreqRecConstellation(coarseCompBuffer); % Plots the constellation of the phase recovered signal               
            obj.pTimingError(timingRecBuffer(1:10:end)); % Plots the time scope of normalized timing error
        end
