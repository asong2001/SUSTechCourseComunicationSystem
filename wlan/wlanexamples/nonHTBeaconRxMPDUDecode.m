function [validBeacon, mpdu] = nonHTBeaconRxMPDUDecode(payload)
...
persistent hCRC defaultMPDU

% Frame check sequence (FCS)
if isempty(hCRC)
    hCRC = comm.CRCDetector([32 26 23 22 16 12 11 10 8 7 5 4 2 1 0], ...
        'InitialConditions', 1, ...
        'DirectMethod',      true, ...
        'FinalXOR',          1);
...
if (length(payload) >= 32+16)
    ...
    [frame, mpduCRCd] = step(hCRC, double(payload));
