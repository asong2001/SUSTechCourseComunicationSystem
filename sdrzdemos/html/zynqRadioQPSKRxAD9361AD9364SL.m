...
% sent by the <matlab:showdemo('zynqRadioQPSKTxAD9361AD9364SL') QPSK Transmitter with
% Analog Devices(TM) AD9361/AD9364> model. The receiver demodulates the
% received symbols and outputs a simple message to the MATLAB(R) command
% line.
% 
...
%
% In this example, the <matlab:sdrzdoc('comminternalsdrrxzc706fmc23sl') ZC706 
% and FMCOMMS2/3/4 Receiver> block receives a signal impaired by the over-the-air
...
% signal sources:
%
% * The <matlab:showdemo('zynqRadioQPSKTransmitterAD9361AD9364ML') QPSK Transmitter
% Using Analog Devices AD9361/AD9364> MATLAB example.
% * The <matlab:showdemo('zynqRadioQPSKTxAD9361AD9364SL') QPSK Transmitter Using Analog Devices AD9361/AD9364> Simulink example.
...
%
modelname = 'zynqRadioQPSKRxAD9361AD9364SL';
open_system(modelname);
set_param(modelname, 'SimulationCommand', 'update')
%%
% The *Signal Specification* block is used to impart a sample rate on the 
% receiver block data output.
%
...
%
% * *Automatic Gain Control* - Applies a variable gain to try to keep the
...
% example in <matlab:showdemo('zynqRadioQPSKReceiverAD9361AD9364ML') QPSK Receiver with
...
% <matlab:showdemo('commqpsktxrx') QPSK Transmitter and Receiver>.
...
%
% * <matlab:edit('zynqRadioQPSKRxAD9361AD9364SL_init') zynqRadioQPSKRxAD9361AD9364SL_init.m>: returns a structure
