...
% <matlab:showdemo('zynqRadioWalkieTalkieRxAD9361AD9364SL') Walkie-Talkie Receiver with
% Analog Devices(TM) AD9361/AD9364> example if you have a second SDR platform.
%
...
%
% * The <matlab:showdemo('zynqRadioWalkieTalkieReceiverAD9361AD9364ML') Walkie-Talkie
% Receiver Using Analog Devices AD9361/AD9364> MATLAB(R) example
% * The <matlab:showdemo('zynqRadioWalkieTalkieRxAD9361AD9364SL') Walkie-Talkie Receiver with
% Analog Devices AD9361/AD9364> Simulink example
...
%%
% The system has been split up into a number of subsystems, each performing
% a specific task: 
%
...
% upsampled to the radio baseband rate of 528 kHz. It uses an FIR
% Interpolator block, the filter coefficients of which are generated in the
% helper function <matlab:edit('zynqRadioWalkieTalkieTxHelperAD9361AD9364SL_SimParams.m')
% zynqRadioWalkieTalkieTxHelperAD9361AD9364SL_SimParams.m>. 
...
% <matlab:sdrzdoc('comminternalsdrtxzc706fmc23sl') ZC706 and Analog Devices
% FMCOMMS2/3/4 Transmitter> block. The SDR hardware is configured to use input ports for
% the RF center frequency. Using an input port for these parameters allows 
% them to be updated while the model is running. The desired center frequency 
...
%
% The upsample by 66 from 8 kHz to 528 kHz is done in software. The upsample
% to 528 kHz is necessary for two reasons:
%
...
% by SDR basebasnd sample rate. To make the software sample rates meaningful, the 
% sample rates at the software/hardware interface must match. For the AD9361/AD9364, 
% one of the possible baseband sample rates that is a multiple of 8 kHz and greater
...
% subsystem with an _Audio Device Reader_ block from the Audio System
% Toolbox(TM). This would allow you to transmit audio captured from a
...
% <matlab:showdemo('zynqRadioWalkieTalkieTransmitterAD9361AD9364ML') Walkie-Talkie Transmitter
% Using Analog Devices AD9361/AD9364 using MATLAB> example.
...
%
% * <matlab:edit('zynqRadioWalkieTalkieTxHelperAD9361AD9364SL_SimParams.m')
% zynqRadioWalkieTalkieTxHelperAD9361AD9364SL_SimParams.m>: returns a structure of variables
% used to control constant parameters in the model.
% * <matlab:edit('sdrzWalkieTalkieTxHelper_ModelParamsMask.m')
% zynqRadioWalkieTalkieTxHelper_ModelParamsMask.m>: controls the *Model
...
% zynqRadioWalkieTalkieHelper_CTCSSCode2Tone.m>: converts a CTCSS code to a
% frequency.
% * <matlab:edit('sdrzWalkieTalkieHelper_Channel2Frequency.m')
% zynqRadioWalkieTalkieHelper_Channel2Frequency.m>: converts a channel number to
% an RF frequency. 
