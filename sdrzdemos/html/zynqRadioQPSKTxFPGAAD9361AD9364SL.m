...
% <matlab:showdemo('zynqRadioQPSKTxAD9361AD9364SL') zynqRadioQPSKTxAD9361AD9364SL> example and the commqpsktxhdl
...
%
% # Run the <matlab:zynqRadioQPSKTxFPGAAD9361AD9364SL zynqRadioQPSKTxFPGAAD9361AD9364SL> targeting model
% directly. See the <#3 Running the Example: Simulated> section.
% # Generate a targeted bitstream and use the retargeted model
% <matlab:zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL>. See the <#4
...
%
% * The <matlab:showdemo('zynqRadioQPSKRxAD9361AD9364SL') QPSK Receiver Using Analog Devices(TM) AD9361/AD9364>
% Simulink example
% * The <matlab:showdemo('zynqRadioQPSKReceiverAD9361AD9364ML') QPSK Receiver Using Analog Devices AD9361/AD9364> MATLAB(R) example
% * The <matlab:showdemo('zynqRadioQPSKRxFPGAAD9361AD9364SL') Targeting HDL-Optimized QPSK
% Receiver Using Analog Devices AD9361/AD9364> Simulink example


%% Running the Example: Simulated
%
% To run the example directly, open <matlab:zynqRadioQPSKTxFPGAAD9361AD9364SL zynqRadioQPSKTxFPGAAD9361AD9364SL>
% and start the simulation. Note that this simulates the entire baseband
% design in a similar way to the <matlab:showdemo('zynqRadioQPSKTxAD9361AD9364SL') QPSK
% Transmitter Using Analog Devices AD9361/AD9364> Simulink example i.e. no HDL code is
...
%
% The <matlab:zynqRadioQPSKTxFPGAAD9361AD9364SL zynqRadioQPSKTxFPGAAD9361AD9364SL> model can be used to generate
...
% *Target platform*, select the appropriate option for you radio hardware (e.g. 'ZC706 and FMCOMMS2/3/4', 'Zedboard and FMCOMMS2/3/4' or 'PicoZed SDR'). The
...
% <matlab:zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL
% zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL>, whose transmit structure is shown in the figure
% below.
modelname = 'zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL';
load_system(modelname);
open_system(modelname);
%%
% This model can be built from the original <matlab:zynqRadioQPSKTxFPGAAD9361AD9364SL
% zynqRadioQPSKTxFPGAAD9361AD9364SL> model by removing the *Data Type Conversion* block
% and the *HDLTx* subsystem. *The functionality of these blocks is now
% implemented on the FPGA.*
%
% With the targeted SD card image loaded, simulating the
% zynqRadioQPSKTxFPGAAD9361AD9364RetargetSL model will start transmitting the 'Hello world'
% messages.
...
%
% The structure of the full QPSK transmitter in <matlab:zynqRadioQPSKTxFPGAAD9361AD9364SL
% zynqRadioQPSKTxFPGAAD9361AD9364SL> is shown in the figure below.
modelname = 'zynqRadioQPSKTxFPGAAD9361AD9364SL';
load_system(modelname);
open_system(modelname);
%%
% The HDL-optimized part of the QPSK transmitter is modeled in the *HDLTx*
% subsystem, whose contents are shown below. This is the DUT that will be
...
%
% * <matlab:edit('zynqRadioQPSKTxFPGAAD9361AD9364SL_init.m') zynqRadioQPSKTxFPGAAD9361AD9364SL_init.m>:
