...
% companion <matlab:showdemo('zynqRadioWalkieTalkieTxAD9361AD9364SL') Walkie-Talkie
% Transmitter Using Analog Devices(TM) AD9361/AD9364> example if you have a second SDR platform.
%
...
%
% * The <matlab:showdemo('zynqRadioWalkieTalkieTransmitterAD9361AD9364ML') Walkie-Talkie
% Transmitter Using Analog Devices AD9361/AD9364> MATLAB(R) example
% * The <matlab:showdemo('zynqRadioWalkieTalkieTxAD9361AD9364SL') Walkie-Talkie Transmitter
...
% from the SDR hardware via an <matlab:sdrzdoc('comminternalsdrrxzc706fmc23sl')
% ZC706 and Analog Devices FMCOMMS2/3/4 Receiver> block. The SDR hardware is configured
% to use input ports for the RF center frequency. Using an input port for these parameters allows them to be
% updated while the model is running. The desired center frequency is
% dependent on the channel selected in the *Model Parameters* block. 
...
% length.
%
% The AGC block is from the Communications System Toolbox(TM). The automatic gain
...
% *Software Decimation*
%
% A decimation filter converts the 640 kHz radio baseband rate to 8 kHz.
...
%
% The *CTCSSCodecompare* function compares the received CTCSS code with the
...
%
% # The SDR hardware baseband rate, *640 kHz*
% # The audio sample rate, *8 kHz*
%
% The downsample by 80 from 640 kHz to 8 kHz is done in software using a
% <matlab:doc('dsp.FIRDecimator') dsp.FIRDecimator> object,
% _softwareDecimator_. The radio baseband
% rate of 640 kHz is necessary for two reasons:
%
...
% transmission rates. The actual reception rate is determined entirely by
% the SDR hardware baseband sample rate. To make
% the software sample rates meaningful, the sample rates at the
% software/hardware interface must match. For the AD9361/AD9364, one of the
% possible baseband sample rates that is a multiple of 8 kHz and greater
% than 13 kHz is 640 kHz. Using an integer downsampling factor means a
...
% <matlab:showdemo('zynqRadioWalkieTalkieReceiverAD9361AD9364ML')
% Walkie-Talkie Receiver Using
% Analog Devices AD9361/AD9364 using MATLAB> example.
...
%
% * <matlab:edit('zynqRadioWalkieTalkeRxHelperAD9361AD9364SL_SimParams.m')
% zynqRadioWalkieTalkieRxHelperAD9361AD9364SL_SimParams.m>: returns a structure of variables
